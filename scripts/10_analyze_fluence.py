...
bm1       = fh5['run_498541/event_info/bl_3/oh_2/bm_1_pulse_energy_in_joule'][:]
bm2       = fh5['run_498541/event_info/bl_3/oh_2/bm_2_pulse_energy_in_joule'][:]
...
plt.plot(q,Iq_on_m/defaultGain/(norm_on/norm_off),label='laser on')
plt.plot(q,Iq_off_m/defaultGain,label='laser off')
...
plt.plot(bin_centers, hist, label='mean intensity')
